/*
 * Pin_KinDyn_V4_Leg for speedbot_v4 leg-only robot.
 * Upper-body joints are fixed in URDF/XML.
 *
 * Pinocchio joint ordering (active):
 *   leg_l: 0-5, leg_r: 6-11
 *   q:  [base(7), leg_l(6), leg_r(6)] = 19
 *   dq: [base(6), leg_l(6), leg_r(6)] = 18
 */
#pragma once
...
public:
    ...
    Eigen::Matrix<double, 6, -1> J_r, J_l, J_base, J_hip_link, J_r_body, J_l_body;
    ...
    Pin_KinDyn_V4_Leg(std::string urdf_pathIn);
