/*
 * WBC_priority_V4_Weld: Whole-body controller for speedbot_v4_weld robot.
 * Adapted from wbc_priority.h for OpenLoong.
 */
#pragma once
...
public:
    ...
    WBC_priority_V4_Weld(int model_nv_In, int QP_nvIn, int QP_ncIn, double miu_In, double dt);
    ...
    void computeDdq(Pin_KinDyn_V4_Weld &pinKinDynIn);
private:
